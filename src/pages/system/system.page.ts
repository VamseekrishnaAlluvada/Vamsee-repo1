...
export class SystemPage extends BasePage {
  readonly heading: Locator = this.page.getByRole('heading', { name: /system/i });
  readonly navMenu: Locator = this.page.getByRole('navigation');
  readonly userMenu: Locator = this.page.getByRole('button', { name: /account|profile|user|menu/i }).first();
