...
export class DeviceSecurityPage extends BasePage {
  readonly pageHeading: Locator = this.page.getByRole('heading', { name: /device\s*&?\s*security/i });
  ...
  async open(): Promise<void> {
    await this.page.goto('/navigator/device-security');
