...
export class ForecastApi extends BaseApi {
  ...
  async verifyGETV1ForecastForMumbaiReturns200WithA(): Promise<APIResponse> {
  ...
  async rejectGETV1ForecastWithA4xxWhenLatitudeIsNon(): Promise<APIResponse> {
  ...
  async rejectGETV1ForecastWithA4xxWhenTheRequired(): Promise<APIResponse> {
  ...
  async confirmGETV1ForecastStillReturns200WhenAn(): Promise<APIResponse> {
  ...
  /** GET https://api.open-meteo.com/v1/forecast?latitude=200&longitude=77.59&daily=temperature_2m_max,temperature_2m_min,precipitation_sum&timezone=Asia/Kolkata */
  async rejectGETV1ForecastWith4xxWhenLatitude200Is(): Promise<APIResponse> {
    return this.send("GET", "https://api.open-meteo.com/v1/forecast?latitude=200&longitude=77.59&daily=temperature_2m_max,temperature_2m_min,precipitation_sum&timezone=Asia/Kolkata", {
      headers: {"Accept":"application/json"},
    });
  }
}
